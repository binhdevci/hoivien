...
var tree_data = {
	'HN' : {name: 'Chi nhánh Hà Nội', type: 'folder'}	,
	'HCM' : {name: 'Chi nhánh Tp HCM', type: 'folder'}	,
	'CT' : {name: 'Chi nhánh Cần Thơ', type: 'folder'}	
}

tree_data['HN']['additionalParameters'] = {
	'children' : {
		'cash' : {name: 'Thu ngân', type: 'item'},
		'supervisor' : {name: 'Tổ trưởng', type: 'item'},
		'sale' : {name: 'Bán hàng', type: 'item'}
	}
}
...
tree_data['CT']['additionalParameters'] = {
	'children' : {
		'cash' : {name: 'Thu ngân', type: 'item'},
		'supervisor' : {name: 'Tổ trưởng', type: 'item'},
		'sale' : {name: 'Bán hàng', type: 'item'}
...
var tree_data_branch = {
	'company' : {name: 'Tổng công ty', type: 'folder'}	
}

tree_data_branch['company']['additionalParameters'] = {
	'children' : {
		'branch1' : {name: 'Chi nhánh Hà Nội', type: 'item'},
		'branch2' : {name: 'Chi nhánh Tp HCM', type: 'item'},
		'branch3' : {name: 'Chi nhánh Cần Thơ', type: 'item'}
	}
}
var treeDataSourcePermission = new DataSourceTree({data: tree_data});
var treeDataSourceBranch = new DataSourceTree({data: tree_data_branch});
